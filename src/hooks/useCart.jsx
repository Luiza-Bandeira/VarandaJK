...
export const CartProvider = ({ children }) => {
  ...
  const generateWhatsAppMessage = (customerName, customerAddress, paymentMethod) => {
  ...
  const getWhatsAppLink = (customerName, customerAddress, paymentMethod) => {
    const message = generateWhatsAppMessage(customerName, customerAddress, paymentMethod);
